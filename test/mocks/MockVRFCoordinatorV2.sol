...
// A mock for testing code that relies on VRFCoordinatorV2. Copied from
// chainlink-brownie-contracts and modified to remove solc warnings.
...
contract VRFCoordinatorV2Mock is VRFCoordinatorV2Interface {
    ...
    function requestSubscriptionOwnerTransfer(uint64, address)
        external
        pure
        override
    {
